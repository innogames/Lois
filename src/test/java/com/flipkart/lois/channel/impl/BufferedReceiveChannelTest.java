...
public class BufferedReceiveChannelTest {

    @Test
    public void open_and_receive_from_channel() {
        //given
        Channel<String> channel = new BufferedChannel<>(10);
    ...
    public void channel_return_true_on_hasNext_if_is_open_and_filled() {
        //given
        Channel<String> channel = new BufferedChannel<>(2);
    ...
    @Test
    public void receiving_last_element_time_should_block() throws InterruptedException {
        //given
